...
while True:
    ...
    cv2.line(frame1,(25,counter_line_position),(1200,counter_line_position),(255,127,0),3)
    ...
    for (i,c) in enumerate(counterShape):
        ...
        cv2.putText(frame1,"VEHICLE COUNTER :"+str(counter),(x,y-20), cv2.FONT_HERSHEY_SIMPLEX,1,(225,224,0),2)
        ...
        for (x,y) in detect:
            if y<(counter_line_position + offset) and y>(counter_line_position - offset):
                counter+=1
                cv2.line(frame1,(25,counter_line_position),(1200,counter_line_position),(0,127,255),3)
                detect.remove((x,y))
